...
void VulkanEngine::init_triangle_pipeline()
{
	...
	if (!vkutil::load_shader_module("src/colored_triangle.frag.spv", _device, &triangleFragShader)) {
	...
	if (!vkutil::load_shader_module("src/colored_triangle.vert.spv", _device, &triangleVertexShader)) {
...
void VulkanEngine::init_mesh_pipeline()
{
	...
	VkShaderModule triangleVertexShader;
	if (!vkutil::load_shader_module("src/colored_triangle_mesh.vert.spv", _device, &triangleVertexShader)) {
		fmt::print("Error when building the triangle vertex shader module");
	}
	else {
		fmt::print("Triangle vertex shader succesfully loaded");
...
if (!vkutil::load_shader_module("src/gradient.comp.spv", _device, &gradientShader)) {
	fmt::print("Error when building the compute shader \n");
}

VkShaderModule skyShader;
if (!vkutil::load_shader_module("src/sky.comp.spv", _device, &skyShader)) {
	fmt::print("Error when building the compute shader \n");
}
...
void VulkanEngine::draw_background(VkCommandBuffer cmd) // also render loop
{
...
void VulkanEngine::run() // render loop
{
    SDL_Event e;
    bool bQuit = false;
